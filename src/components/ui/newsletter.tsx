      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div
            ...
            className="absolute -top-20 -right-20 w-64 h-64 bg-yellow-200 rounded-full opacity-20 blur-3xl"
          />
          <motion.div
            animate={{
              scale: [1.2, 1, 1.2],
            ...
            className="absolute -bottom-20 -left-20 w-80 h-80 bg-purple-200 rounded-full opacity-20 blur-3xl"
          />
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-[#95111c] to-[#7a0e16] rounded-full mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#95111c] mb-6"
          >
          ...
          >
            {benefits.map((benefit, idx) => (
              <motion.div
                ...
                className="bg-linear-to-br from-purple-50 to-blue-50 rounded-xl p-6 text-center shadow-lg hover:shadow-xl transition-shadow"
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <Input
                      ...
                      required
                      placeholder="John"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#95111c] focus:border-transparent"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {interestOptions.map((option) => (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`flex items-center cursor-pointer gap-3 p-3 rounded-lg border-2 transition-all ${
