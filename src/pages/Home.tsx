          ...
          <div className="max-w-7xl mx-auto w-full">
            <div className="max-w-3xl text-white space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl font-light leading-relaxed max-w-2xl">
                ...
                African scholarship and solve real-world development challenges
        ...
        <div className="max-w-4xl mx-auto relative text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Driving excellence in African scholarship through collaboration
              and innovation
            </p>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Strategic interventions designed to empower African scholars at
            ...
            {testimonials.map((testimonial, idx) => (
              ...
              >
                ...
                <div className="border-t pt-4">
                  <p className="font-bold text-[#95111c]">{testimonial.name}</p>
